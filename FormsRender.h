...
namespace RevitPixeR {
	...
	private:
		...
		List<ElementId^>^ lights = gcnew List<ElementId^>();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBoxSky->Items->AddRange(gcnew cli::array< System::Object^  >(3) {
				L"-3hs (Horário de Brasília)", L"Parcialmente Nublado",
					L"Nublado"
			});
			this->comboBoxSky->Location = System::Drawing::Point(76, 50);
			this->comboBoxSky->Name = L"comboBoxSky";
			this->comboBoxSky->Size = System::Drawing::Size(143, 21);
			...
			this->labelSky->Size = System::Drawing::Size(67, 13);
			this->labelSky->TabIndex = 1;
			this->labelSky->Text = L"Fuzo Horário";
			// 
			// labelArtificial
			// 
		...
		{
			FormLight^ fl = gcnew FormLight(commandData, lights);
			fl->ShowDialog();
